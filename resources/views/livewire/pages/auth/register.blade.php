...
new #[Layout('layouts.guest')] class extends Component
{
    public string $name = '';
    public string $email = '';
    public string $phone = ''; // Tambahan properti phone
    ...
    public function register(): void
    {
        $validated = $this->validate([
            ...
            'phone' => ['required', 'string', 'max:20'], // Validasi nomor telepon
            'password' => ['required', 'string', 'confirmed', Rules\Password::defaults()],
        ]);

        $validated['password'] = Hash::make($validated['password']);
        $validated['role'] = 'customer'; // Set otomatis jadi customer

        event(new Registered($user = User::create($validated)));

        Auth::login($user);

        // Arahkan ke beranda (home) setelah sukses mendaftar
...
<div>
    <form wire:submit="register">
        ...
        <!-- No Telepon (Tambahan Baru) -->
        <div class="mt-4">
            <x-input-label for="phone" :value="__('No. WhatsApp / Telepon')" />
